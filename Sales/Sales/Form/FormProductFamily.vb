...
Public Class FormProductFamily

    Delegate Sub ProgressReportDelegate(ByVal id As Integer, ByVal message As String)
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Public myAdapter As FamilyDataAdapter
    ...
    Public Sub New()
        ...
        AddHandler DialogProductFamily.FinishTask, AddressOf refreshdatagrid
    End Sub
    ...
    Sub DoWork()
        myAdapter = New FamilyDataAdapter
        Try
    ...
    Private Sub ShowTx(ByVal tx As TxRecord)
        ...
        End Select
        Dim myform As New DialogProductFamily(drv)
        myform.Show()
    End Sub
